...
// File: contracts/Cryptotickets.sol
...
// File: contracts/TicketsFactory.sol
...
contract TicketsFactory is Factory, Ownable {
    ...
    uint256 SINGLE_TICKET_OPTION = 0;
    ...
    function mint(uint256 _optionId, address _toAddress) public {
        ...
        require(canMint(_optionId), "could not mint");

        Cryptotickets cryptoticket = Cryptotickets(nftAddress);
        if( _optionId ==  SINGLE_TICKET_OPTION ){
    ...
    function canMint(uint256 _optionId) public view returns(bool){
        ...
        return ticketSupply < (TICKET_SUPPLY - numItemsAllocated);
